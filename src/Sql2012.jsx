...
function Sql2012() {
    ...
    const [reports,setReports] =useState([]);
        ...
        useEffect(() =>{
fetch("http://localhost:8082/release2012")
...
const CaptionElement = () => <h3 style={{ borderRadius: '0.3em', textAlign: 'center', color: 'black', border: '1px solid black', padding: '0.1em' , width:'50%' ,position: 'sticky' , top: 0 }}>Microsoft SQL Server 2012</h3>;
