...
function SU() {
    ...
    const [reports,setReports] =useState([]);
        ...
        useEffect(() =>{
fetch("http://localhost:8082/SuUpdate")
...
const CaptionElement = () => <h3 style={{ borderRadius: '0.3em', textAlign: 'center', color: 'black', border: '1px solid black', padding: '0.1em' , width:'50%' ,position: 'sticky' , top: 0 }}>Security Update</h3>;
